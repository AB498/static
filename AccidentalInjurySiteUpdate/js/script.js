...
$('button[type="submit"]').click(async function (e) {
  ...
  if (!email.val()) {
    ...
    email.parents(".email").find(".error-message")[0].textContent =
      "This field is required";
    errors = 1;
  } else {
  ...
  if (!phone.val()) {
    ...
    phone.parents(".phone").find(".error-message")[0].textContent =
      "This field is required";
    errors = 1;
  } else {
  ...
  if (!injured?.val()) {
    $('input[name="injured"]')
      .parents(".question")
      .find(".error-message")[0].style.display = "block";
    $('input[name="injured"]')
      .parents(".question")
      .find(".error-message")[0].textContent = "This field is required";
    errors = 1;
  } else {
    $('input[name="injured"]')
      .parents(".question")
      .find(".error-message")[0].style.display = "none";
  }
  if (!fault?.val()) {
    $('input[name="fault"]')
      .parents(".question")
  ...
  if (errors) {
    ...
    if (result.status == "Error") {
      ...
      $('input[name="secondInjured"]')
        .parents(".question")
        .find(".error-message")[0].textContent =
...
async function isValidPhone(phoneNumber) {
  ...
  let url =
    "https://monetise.leadbyte.co.uk/restapi/v1.2/validate/mobile?key=" +
    api_key +
    "&value=" +
    phoneNumber;
