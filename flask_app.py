# pip install flask requests flask_cors flask_mysqldb spire.doc
...
def on_exit(signum, frame):
    process.terminate()
signal.signal(signal.SIGCHLD, on_exit)
process = subprocess.Popen(['bash', '-c', 'source ~/.bashrc', '&&', '/home/ab498/node/bin/nodemon', '/home/ab498/node_main_app/server.js'], preexec_fn=os.setpgrp)
